...
@section('content')
    ...
    @php
        ...
        $initialAbout = (isset($abouts)) ? $abouts : [
            'id' => null, 
            'log_id' => null, 
            'title' => '', 
            'description' => '', 
    ...
    <div class="flex flex-col gap-5">
        ...
        <form action="{{ route('cms.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div x-data="{ log_id: @js($log_id), heroes: @js($initialHeroes), about: @js($initialAbout) }"
            ...
            <div class="shadow-md border border-gray-300 p-5 rounded-lg flex flex-col mt-5">
                ...
                <div class="flex flex-col gap-1 mt-4">
                    ...
                    <input type="text" name="aboutus-title" class="p-2 border border-gray-300 rounded-lg text-sm font-semibold focus:outline-none focus:border-blue-500" placeholder="Judul About Us...">
                </div>

                <div class="flex flex-col gap-1 mt-4">
                    <label class="text-sm font-semibold">Deskripsi</label>
                    <input type="text" name="aboutus-description" class="p-2 border border-gray-300 rounded-lg text-sm font-semibold focus:outline-none focus:border-blue-500" placeholder="Judul About Us...">
                </div>

                <div x-data="{}" class="flex flex-col gap-1 mt-4">
                    <label class="text-sm font-semibold">Warna Background</label>
                    <select name="aboutus-background">
