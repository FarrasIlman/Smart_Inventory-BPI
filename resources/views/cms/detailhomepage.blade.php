...
@section('content')
    ...
    $isNew = !isset($log_id) || !$log_id;
        ...
        <div class="flex flex-col gap-5">
            ...
            <form
                x-data="{ log_id: @js($log_id), heroes: @js($initialHeroes), about: @js($initialAbout), service: @js($initialService), showModal: false, isSubmitting: false, isDraft: false, notes: '', uploadWarning: false }"
                                ...
                                <div x-data="{
                                    ...
                                    <div x-show="!serviceImgUrl"
                                        ...
                                        <input type="file" :name="`service[details][${index}][image]`" accept="image/*"
                                            class="absolute z-20 inset-0 opacity-0" @change="
                                                                                                                    const file = event.target.files[0];
                ...
                <div class="flex items-center justify-end mt-5">
                    @if ($isNew)
                        <div class="flex flex-row items-center gap-3">
                            <button type="submit" name="status" value="draft" class="px-4 py-2 rounded-lg bg-gray-500 hover:bg-gray-700">
