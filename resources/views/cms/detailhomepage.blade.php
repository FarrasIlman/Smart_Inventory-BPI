            ...
            [
                ...
                'image_id' => null
                    ...
                    <div class="flex flex-col gap-5">
                        ...
                        <form x-data="{ log_id: @js($log_id), heroes: @js($initialHeroes), about: @js($initialAbout), service: @js($initialService) }" action="{{ route('cms.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <template x-for="(color, index) in about.bg_config.colors" :key="index">
                                        <div class="flex flex-row items-center gap-2">
                                            ...
                                            <button x-show="about.bg_config.colors.length > 1" type="button"
                                                class="px-4 py-2 bg-red-500 rounded-lg text-white text-sm"
                                                @click="
                            ...
                            <div class="mt-5 flex flex-col shadow-md border border-gray-300 rounded-lg p-5">
                                ...
                                <div class="flex flex-col gap-2 mt-4">
                                    ...
                                    <input type="text" x-model="service.title" name="about[title]" class="p-2 rounded-lg border border-gray-300 focus:outline-none focus:border-blue-500"  />
                                </div>

                                <div class="flex flex-col gap-2 mt-4">
                                    <label class="font-semibold text-sm">Deskripsi</label>
                                    <input type="text" x-model="service.description" name="service[description]" class="p-2 rounded-lg border border-gray-300 focus:outline-none focus:border-blue-500">
                                </div>

                                <div class="flex flex-col gap-2 mt-4">
                                    <label class="text-sm font-semibold">Tipe Background</label>
                                    <select x-model="service.bg_config.type" class="p-2 rounded-lg border border-gray-300 focus:outline-none focus:border-gray-500 text-sm" @change="
                                ...
                                <div x-show="service.bg_config.type === 'solid'" class="mt-4 flex flex-col gap-2">
                                    ...
                                    <div class="flex flex-row items-center gap-2">
                                        <input type="color" x-model="service.bg_config.colors[0]" class="w-10 h-10 p-1 border border-gray-300 rounded-lg">
                                        <input type="text" x-model="service.bg_config.colors[0]" class="p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-gray-300 text-sm">
                                    </div>
                                </div>  
                                ...
                                <div x-show="service.bg_config.type === 'gradient'" class="flex flex-col gap-1 mt-4">
                                    <template x-for="(color, index) in service.bg_config.colors" :key="index">
                                        <div class="flex flex-row items-center gap-2">
                                            <input type="color" x-model="service.bg_config.colors[index]" class="w-10 h-10 p-1 border border-gray-300 rounded-lg">
                                            <input type="text" x-model="service.bg_config.colors[index]" class="p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-gray-300 text-sm">
                                            <button x-show="service.bg_config.colors.length > 1" type="button" class="px-4 py-2 bg-red-500 text-white rounded-lg font-semibold text-sm" @click="
                                    ...
                                    <button type="button" x-show="service.bg_config.colors.length < 3" class="mt-2 w-fit p-2 bg-gray-700 rounded-lg text-white font-semibold text-sm" @click="service.bg_config.colors.push('#000000')"> 
                                        Tambah Warna
                                    </button>
                                </div>
                                ...
                                <div class="mt-4 flex flex-col gap-2">
                                    <div class="flex flex-row items-center justify-between">
                                        ...
                                        <button type="button" class="text-sm font-semibold text-white bg-gray-700 px-4 py-2 rounded-lg" @click="
                                    ...
                                    <template x-for="(detail, index) in service.details" :key="index">
                                        <div class="p-4 shadow-md border border-gray-300 rounded-lg flex flex-col mb-2">
                                            <div class="flex flex-row items-center justify-between">
                                                ...
                                                <button x-show="service.details.length > 1" class="px-4 py-2 rounded-lg bg-red-500 text-white font-semibold text-sm" @click="service.details.splice(index, 1)">
                                                    Hapus
                                                </button>
                                            </div>
                                            <div class="flex flex-col gap-1 mt-2">
                                                <label class="text-sm font-semibold">Nama Layanan</label>
                                                <input type="text" x-model="detail.name" :name="`service[details][${index}][name]`" class="p-2 rounded-lg border border-gray-300 text-sm focus:outline-none focus:border-gray-500">
                                            </div>
                                            <div class="flex flex-col gap-1 mt-2">
                                                <label class="text-sm font-semibold">Deskripsi Layanan</label>
                                                <textarea x-model="detail.description" :name="`service[details][${index}][description]`" class="p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-gray-500"></textarea>
                                            </div>
                                            <div x-data="{
                                                ...
                                                <div x-show="!serviceImgUrl" class="rounded-lg border-2 border-dashed border-blue-500 flex items-center justify-center relative p-4 hover:bg-gray-200">
                                                    <input type="file" x-model="detail.image" :name="`service[details][${index}][image]`" accept="image/*" class="absolute z-20 inset-0 opacity-0" @change="
                                                        const file = event.target.files[0];
                                                ...
                                                <div x-show="serviceImgUrl" class="p-4 shadow-md border border-gray-300 flex flex-row items-center justify-between">
                                                    <div class="flex flex-row gap-2">
                                                        ...
                                                        <div class="flex flex-col gap-2">
                                                            <a :href="serviceImgUrl" target="_blank" class="text-sm text-blue-500" x-text="serviceFileName"></a>
